...
CREDENTIALS_FILE = os.getenv("CREDENTIALS_FILE")  # Обязательно: /etc/secrets/credentials.json
...
def send_report(chat_id):
    ...
    bot.send_message(CHAT_ID_FOR_REPORT, report_msg, message_thread_id=THREAD_ID_FOR_REPORT)
